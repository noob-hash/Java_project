            ...
            <div class="body">
                ...
                <section id="patient_data">
                    <div class="flex">
                        ...
                        <%
                            ArrayList<model> lst = (ArrayList<model>)request.getAttribute("appoinmentToday");
                            ArrayList<model> list = (ArrayList<model>)request.getAttribute("appoinments");
                            for(model l : lst){
                        %>
                            <a href="controller?identifiedBy=<%=l.getPhone()%>">
                                <div class="column patient">
                                    <div><%=l.getId()%></div> 
                                    <div><%=l.getName()%></div> 
                                    <div><%=l.getTime()%></div>
