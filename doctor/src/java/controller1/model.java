...
public class model {
    ...
    public model(int id, String name,String time,String phone){
        this.id=id;
        this.name=name;
        this.time=time;
        this.phone=phone;
    ...
    public model(int id,String name,String gender,int age,String phone,String Bg,String Allergies){
        this.name=name;
        this.id=id;
        this.gender=gender;
        this.age=age;
    ...
    //for patient data stores data to be shown in record
    public model(int id,String name,int totalApp,int upcomingApp,String gender,int age,String phone,String Bg,String Allergies,int height,int weight,int temp,int pulse,String bp,String diagonisis,String TP, String Presciption,String TR,String date){
        this.name=name;
        this.id=id;
