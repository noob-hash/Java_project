...
<html>
    ...
    <body>
        <div class="divider">
            <nav>
                <ul>
                    <li><img src="logoH.png" alt="Hospital logo" height="37" width="103"></li>
            ...
            <div class="main flex">
                <div class="column">
                    ...
                    <form action="NewServlet" method="post" class="box">
                        ...
                        <div class="flex">
                            <button type="submit" name="button" value="addDep">Add Department</button>
                ...
                <div class="table">
                    <table border="0">
                        ...
                        %>
                        <form action="NewServlet?id=<%=l.getId()%>" method="post">
                            <tr>
                                <td><%=l.getId()%></td>
                                <td><%=l.getName()%></td>
                                <td><%=l.getPhone()%></td>
                        ...
                        <form action="NewServlet?id=<%=l.getId()%>" method="post">
                            <tr>
                                ...
                                <td>
                                    <button class="update" type="submit" name="button" value="update">Save</button>
                                    <button class="delete" type="submit" name="button" value="cancel">Cancel</button>
                                </td>
                            </tr>
                        </form>
                        <%}
