...
<html>
    ...
    <body>
        <div class="top">
            <img src="logoH.png" width="103" height="37" alt="alt"/>
            <a href="controller?to=dashboard">
                <img src="cross.png" width="20" height="20" alt="alt"/>
            </a>
        </div>
        <div class="search">
            ...
            while(rs.next()){
                %>
                <option value="<%=rs.getString("doc_name")%>">
                <option value="<%=rs.getString("doctor_id")%>">
                    <%
                        }
        }catch(Exception e){
