...
public class user_controller extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String today=dtf.format(now);
            ...
            ArrayList<user_model> lst = new ArrayList<>();
            ArrayList<user_model> list = new ArrayList<>();
            ...
            try {
                ...
                while(rs.next()){
                    lst.add(new user_model("a",rs.getString("doc_name")));
                }
                
                request.setAttribute("doctor", lst);
                ResultSet rs1=stmt.executeQuery("Select * from department");
                while(rs1.next()){
                    list.add(new user_model(rs1.getString("dep_name")));
                }
