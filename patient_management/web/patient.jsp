...
<body>
    ...
    <div class="top">
            <div class="lefrig">
                ...
                <div class="dropdown">
                    <form action="patient?identifiedBy=<%=id%>" method="post" class="content">
                        
                        <select name="date" onchange="this.form.submit()">
                            <%
                                ArrayList<doctorModel> lst = (ArrayList<doctorModel>)request.getAttribute("date");
                ...
                <%
                ArrayList<doctorModel> list = (ArrayList<doctorModel>)request.getAttribute("patientData");
