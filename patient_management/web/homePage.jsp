<%-- 
    ...
    Author     : Subin
--%>
<%@page import="userController.user_model" %>
...
<html>
    ...
    <body>
        ...
        <section id="mission" style="margin:30px">
            <div style="display:flex; justify-content: space-between; margin:10vh 0;">
                <div style="float:left;">
                    <span style="font-size:30px;justify-content: center; margin-right:340px">Our Vision</span>
                ...
                <p style="margin-top:10px">
                    Lorem Ipsum dolor sit amet, consectetuer adipscing elit. Duis tellus. Donec <br/>
                    ante dolor, iaculis nec, gravida ac, cursus in eros. Mauris vestibulum,  <br/>
                    egestas ullamcorper, purus nibh. Lorem Ipsum dolor sit amet, consectetuer <br/>
                    ante dolor, iaculis nec, gravida ac, cursus in eros. Mauris vestibulum,<br/> 
                    egestas ullamcorper, purus nibh. Lorem Ipsum dolor sit amet, consectetuer  <br/>
                    ante dolor, iaculis nec, gravida ac, cursus in eros. Mauris vestibulum,t <br/>
                    egestas ullamcorper, purus nibh.
                </p>
                </div>
                <div>
                    <img src="vission.png" width="600" height="450" alt="alt" />
                </div>
            </div>
            
            <br><br>
            <div style="display:flex;justify-content: center;margin: 10vh 0;">
                <div style="flex: 1;margin-right: 20vw;">
                ...
                <img src="resources/mission.jpg" width="500" height="300" alt="alt" style="flex: 1;" />
            </div>
        </section>
                <%
                    int b=0;
                    ...
                    int ml=0;
                    ArrayList<user_model> list=(ArrayList<user_model>)request.getAttribute("department");
                    for(user_model l:list){
                    ...
                    ml=0;
                    ArrayList<user_model> last=(ArrayList<user_model>)request.getAttribute("doctor");
                    for(user_model l:last){
    ...
    %>
        <div class="container" style="margin:30px;" id="department">
            ...
            <div style="display:flex; justify-content: center;">
                <a href="?in=(-1)#department" name="previous">
                    <div class="previous">
                        <img src="resources/previous.png" height="304" width="24" alt="alt"/>
                    </div>
                </a>
                ...
                <a href="?in=1#department" name="next">
                    <div class="next">
                        <img src="resources/next.png" height="304" width="24" alt="alt"/>
                    </div>
                </a>
            </div>
        </div>
        ...
        <div style="margin:30px;display: flex;flex-direction: column;" id="appoin">
            ...
            <form action="PatientAppoinment" method="post" class="form">
