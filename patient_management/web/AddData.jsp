...
<html>
            ...
            <div class="nav">
                <nav>
                    <ul>
                        ...
                        <li><h3><a href="doctor?action=logoff">Logout</a></h3></li>
                    </ul>
                </nav>
            </div>
            <div class="partion">
                <%
                    ...
                    ArrayList<doctorModel> lst = (ArrayList<doctorModel>)request.getAttribute("patientInfo");
                ...
                <div class="form">
                    <form action="doctor?action=saveData" method="post">
                        <div class="flex">
                            <div class="input">
                        ...
                        <div  class="flex">
                            <div id="med" class="input">
                                <label for="presc">Presciption</label>
                                <div>
                                    <input  id="medic" type="text" placeholder="Medicine">
                                    <button id="button" class="addPresc">Click</button>
                                </div>      
                            </div>
                        </div>
                        ...
                        <button style="width: fit-content;margin: 0 24vw; padding: 1em;border-radius: 20px; border: 2px solid black;">Submit</button>    
                        <div>
                    </form>
                </div>
                <%}%>
    ...
    <script>
        var elem=document.getElementById("med");            
